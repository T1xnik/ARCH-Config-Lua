...
-- ============================================================================
hl.monitor({ output = "", mode = "preferred@144", position = "auto", scale = 1 })
...
hl.config({
    general = { gaps_in = 15, gaps_out = 30, border_size = 2, col = { active_border = { colors = { "rgba(33ccffee)", "rgba(00ff99ee)" }, angle = 45 }, inactive_border = "rgba(595959aa)" }, resize_on_border = false, allow_tearing = false, layout = "dwindle" },
...
hl.config({ input = { kb_layout = "us,ru", kb_options = "grp:alt_shift_toggle", follow_mouse = 1, sensitivity = 0, touchpad = { natural_scroll = false } } })
hl.gesture({ fingers = 3, direction = "horizontal", action = "workspace" })
hl.config({ layerrule = { { rule = "blur", value = "waybar" }, { rule = "ignorealpha", value = "0.2, waybar" } } })
local mainMod = "SUPER"
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd(terminal))
hl.bind(mainMod .. " + C", hl.dsp.window.close())
hl.bind(mainMod .. " + SHIFT + Q", function() local active = hl.get_active_window() if active and active.pid then hl.exec_cmd("kill -9 " .. active.pid) end end)
...
hl.window_rule({ name = "smaller-firefox", match = { class = "firefox" }, size = "1200 800", center = true })
